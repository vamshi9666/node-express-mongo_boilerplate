...
public class DevelopmentInformation extends Activity {
	ImageView out;
	TextView Bug;
	SQLiteDatabase db;
	ListView l;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ArrayList<String> list = new ArrayList<String>();
		 ...
		 Cursor res=db.rawQuery("SELECT * FROM develop", null);
		if(res.getCount()!=0)
		{
		...
		t1.addTextChangedListener(new TextWatcher(){
			...
			public void onTextChanged(CharSequence s, int start, int before,
					int count) {
				// TODO Auto-generated method stub
				DevelopmentInformation .this.adapter.getFilter().filter(s); 
